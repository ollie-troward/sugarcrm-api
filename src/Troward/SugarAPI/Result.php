...
class Result implements \ArrayAccess, \Iterator {
    ...
    /**
     * @param BaseModuleContract $module
     * @param array $results
     */
    function __construct(BaseModuleContract $module, array $results)
    {
        $this->module = $module;
        $this->results = $this->make($results);
    }
     ...
     * @return array
     */
    protected function make(array $results)
    {
        $collection = [];

        foreach ($results as $result)
        {
            $collection[] = new $this->module($result);
        }
